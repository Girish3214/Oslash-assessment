    ...
    <>
      <div className="home_container">
        ...
        <div className={`main_button_container ${buttonPosition}`}>
          ...
          {toDisplay && (
            <Modal position={`${buttonPosition}_modal`}>
              <ModalContent />
            </Modal>
          )}
        </div>
      ...
      <div className="buttons__container">
        <Button
          backgroundColor="black"
          onClick={() => setButtonPosition("top_left")}
        >
          Top Left
        </Button>
        <Button
          backgroundColor="black"
          onClick={() => setButtonPosition("top_right")}
        >
          Top Right
        </Button>
        <Button
          backgroundColor="black"
          onClick={() => setButtonPosition("bottom_right")}
        >
          Bottom Right
        </Button>
        <Button
          backgroundColor="black"
          onClick={() => setButtonPosition("bottom_left")}
        >
          Bottom left
        </Button>
      </div>
